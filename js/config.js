...
const JANNAT_CONFIG = {
  ...
  services: [
    ...
    // -----------------------------------------------------------------------
    {
      ...
      image: "assets/images/services/ayushman.svg",
      icon: "shield-check",
    ...
    },
    {
      ...
      categoryName: "Health & Government",
      badge: "CSC Service",
      image: "assets/images/services/csc-govt.svg",
      icon: "cpu-chip",
    ...
    },
    {
      ...
      categoryName: "Health & Government",
      badge: "Food & Supplies",
      image: "assets/images/services/ration-card.svg",
      icon: "document-text",
    ...
    },
    {
      ...
      categoryName: "Health & Government",
      badge: "Agriculture",
      image: "assets/images/services/pm-kisan.svg",
      icon: "academic-cap",
    ...
    },
    {
      ...
      image: "assets/images/services/pmfby.svg",
      icon: "shield-check",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      badge: "Through CSC",
      image: "assets/images/services/pan-card.svg",
      icon: "id-card",
    ...
    },
    {
      ...
      image: "assets/images/services/driving-licence.svg",
      icon: "truck",
    ...
    },
    {
      ...
      categoryName: "Identity & Documents",
      badge: "Durable Cards",
      image: "assets/images/services/pvc-printing.svg",
      icon: "credit-card",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      image: "assets/images/services/bank-bc.svg",
      icon: "banknotes",
    ...
    },
    {
      ...
      image: "assets/images/services/axis-bc.svg",
    ...
    },
    {
      ...
      image: "assets/images/services/new-bank-account.svg",
      icon: "building-library",
    ...
    },
    {
      ...
      image: "assets/images/services/loan-assistance.svg",
      icon: "currency-rupee",
    ...
    },
    {
      ...
      image: "assets/images/services/credit-card.svg",
      icon: "credit-card",
    ...
    },
    {
      ...
      categoryName: "Banking & Finance",
      badge: "Life & General",
      image: "assets/images/services/insurance.svg",
      icon: "shield-check",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      image: "assets/images/services/bill-payment.svg",
    ...
    },
    {
      ...
      categoryName: "Payments & Recharge",
      badge: "All Networks",
      image: "assets/images/services/mobile-recharge.svg",
    ...
    },
    {
      ...
      image: "assets/images/services/gas-booking.svg",
      icon: "fire",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      image: "assets/images/services/online-forms.svg",
      icon: "document-text",
    ...
    },
    {
      ...
      image: "assets/images/services/print-scan-xerox.svg",
      icon: "printer",
    ...
    },
    {
      ...
      image: "assets/images/services/computer-services.svg",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      badge: "Hardware Care",
      image: "assets/images/services/mobile-repair.svg",
    ...
    },
    {
      ...
      categoryName: "Mobile & Repair",
      badge: "Software & OS",
      image: "assets/images/services/mobile-software.svg",
      icon: "device-phone-mobile",
    ...
    },
    {
      ...
      image: "assets/images/services/smartphone-troubleshoot.svg",
      icon: "cpu-chip",
    ...
    // -----------------------------------------------------------------------
    {
      ...
      image: "assets/images/services/broadband-fiber.svg",
      icon: "wifi",
    ...
    },
    {
      ...
      image: "assets/images/services/cable-tv.svg",
      icon: "tv",
